...
import data from "../../Data/dunyo.json"
import "./index.css"
export default () => {
    return (
        <div>
            {data.map((val, index) =>
                <Box sx={{ width: "100%", height: "40%", border: "1px solid #E4E4E4", marginBottom: "0.5%" }} className="box">
            ...
            <Box sx={{ width: "100%", height: "100px", border: "1px solid #E4E4E4",display:"flex",alignItems:"center",justifyContent:"center",":hover":{backgroundColor:"black",color:"white"},transition:".5s" }}>

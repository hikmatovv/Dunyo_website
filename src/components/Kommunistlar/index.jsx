...
import data from "../../Data/kolumnist.json"
...
export default () => {
  return (
    <div>
      {data.map((val, index) =>
        <Box>
          <Box sx={{ width: "100%", height: "40%", border: "1px solid #E4E4E4", marginBottom: "0.5%" }}>
              ...
              <Grid container spacing={3} key={index} sx={{ display: "flex", justifyContent: "space-between" }}>
                <Grid xs={12} md={12} sm={12} lg={12} sx={{ padding: "1%", }}>
                  ...
                  <Grid xs={12} md={12} lg={12} sm={12} sx={{ display: "flex", paddingTop: "4%", justifyContent: "space-between" }}>
                    <Grid xs={6} md={6} lg={6} sm={6}>
                      <Typography sx={{ fontFamily: "sans-serif", fontWeight: "200", color: "#A0A0A4", letterSpacing: "3px", paddingTop: "80%", width: "100%" }}>
                        {val.time}
                      </Typography>
                    </Grid>
                  </Grid>
                ...
                <Grid xs={12} md={12} sm={12} lg={12} sx={{ display: "flex", paddingLeft: "2%", }}>
                  <Box sx={{ display: "flex", alignItems: "flex-end", width: "100%", }}>
                    ...
                    <img src={val.imgSrc} alt="dataImg" style={{ width: "42vh", height: "100%", paddingLeft: "0%" }} />
                  </Box>
                </Grid>
              </Grid>
            </Box>
          </Box>
          <Box sx={{ display: "flex", width: "100%", height: "100px", backgroundColor: "#F1F1F1", border: "1px solid #E4E4E4", alignItems: "center", }}>
            <Typography sx={{ display: "flex", fontWeight: "500", fontFamily: "sans-serif", color: "#303030", padding: "2%" }}>
              {val.title2}
            </Typography>
          </Box>
        </Box>
